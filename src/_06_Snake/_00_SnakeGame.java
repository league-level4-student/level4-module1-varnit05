...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Move using the arrow keys. The objective is the grab the item. DO not die";
		...
		//   of the game. The smaller the number, the faster it goes.
			...
			String difficulty = JOptionPane.showInputDialog("choose your difficulty");
		switch(difficulty) {
		case "expert": 
	...
	private void gameOver() {
		...
		int play = JOptionPane.showConfirmDialog(null, "Wanna play again?", "", JOptionPane.YES_NO_OPTION);
		//4. if they want to play again
		//   reset the snake and the food and start the timer
		//   else, exit the game
		Location start = new Location(WIDTH / 2, HEIGHT / 2);
